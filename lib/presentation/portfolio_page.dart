...
import 'package:portfolio_test2/presentation/portfolio_app_bar.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // 1200px 미만은 모바일(태블릿 포함), 이상은 데스크톱
            ...
            children: [
              ...
              CustomScrollView(
                ...
                slivers: [
                  ...
                  // 푸터: 모바일에서는 전체 가로, 데스크톱에서는 본문 폭에 맞춰 노출
                  SliverToBoxAdapter(
                    child:
                        isSmallScreen
                            ? Footer(onNavigationItemTapped: _scrollToSection)
                            : Center(
                              child: ConstrainedBox(
